...
- **Liquid Glass** — macOS 26 Tahoe 以降は `NSGlassEffectView` の上にリムとスペキュラを重ねて描画。それ以前は当時のネイティブなマテリアル
- **3 つのテーマ** — Liquid Glass、ライト、ダーク
- **4 言語対応** — English、한국어、日本語、简体中文。システム追従または手動指定
...
| **テーマ** | リキッド / ライト / ダーク | リキッド |
| **言語** | システム / English / 한국어 / 日本語 / 简体中文 | システム |
