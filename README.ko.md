...
- **리퀴드 글래스** — macOS 26 타호 이상에서는 실제 리퀴드 글래스, 그 이전에는 당시의 네이티브 머티리얼
- **라이트/다크** — 시스템을 따르거나 원하는 쪽으로 고정
- **4개 언어** — English, 한국어, 日本語, 简体中文. 시스템을 따르거나 직접 지정
...
| **유리 불투명도** | 링 뒤 유리를 얼마나 진하게 그릴지 | `100%` |
| **테마** | 시스템 / 밝게 / 어둡게 | 시스템 |
| **언어** | 시스템 / English / 한국어 / 日本語 / 简体中文 | 시스템 |
